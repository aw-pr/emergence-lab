...
const ABOUT: Readonly<Record<string, SimAbout>> = {
  ...
  "logistic-mandelbrot": {
    ...
    interaction:
      "The view orbits in step with the moving glow. Click and drag anywhere in the scene to take over and pivot around the object, then scroll or pinch to zoom through its three-dimensional sheets. Drag the glowing tracer itself to inspect another point on the Mandelbrot plane; double-click or double-tap to return to the opening view.",
  },
  "cyclic-ca": {
    history:
